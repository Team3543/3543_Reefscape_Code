...
public class DriveConstants {
  ...
  public static final int frontLeftThrifty = 0;
  public static final int backLeftThrifty = 2;
  public static final int frontRightThrifty = 1;
  public static final int backRightThrifty = 3;
  ...
  public static final double driveMotorReduction =
      (6.75) / (1); // MAXSwerve with 14 pinion teeth and 22 spur teeth
